...
export class InitialMigration1633543876208 implements MigrationInterface {
    name = 'InitialMigration1633543876208'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "udpatedAt" TIMESTAMP NOT NULL DEFAULT now(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "form" ("id" SERIAL NOT NULL, "creatorId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "udpatedAt" TIMESTAMP NOT NULL DEFAULT now(), "generalFeeling" integer NOT NULL, "weight" double precision NOT NULL, "stoolType" integer NOT NULL, "sleepLenght" double precision NOT NULL, "sleepQuality" integer NOT NULL, "mood" integer NOT NULL, "stress" integer NOT NULL, "inTherapy" boolean NOT NULL, "menstruation" boolean NOT NULL, "migraine" boolean NOT NULL, "pollakiuria" boolean NOT NULL, "notes" character varying NOT NULL, CONSTRAINT "PK_8f72b95aa2f8ba82cf95dc7579e" PRIMARY KEY ("id"))`);
